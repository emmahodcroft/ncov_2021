...
if __name__ == '__main__':
    ...
    parser.add_argument("--crowding-penalty", type = float, default=0.5, required=False, help="parameterizes how priorities decrease when there is many very similar sequences")
