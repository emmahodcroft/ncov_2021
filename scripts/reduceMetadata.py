...
#script to reduce size of metadata file before any analysis (to save compute time)
#- only include lines with dates prior to 2022-06-30

# Input and output file paths
input_file = 'metadata.tsv'
output_file = 'metadata-reduced-2022-06-30_USED-IN-DATA.tsv'

# Predefined date for comparison
compare_date = datetime(2022, 6, 30)
